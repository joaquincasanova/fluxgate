...
for ac_index in range(1,ac_levels+1):
    for dc_index in range(1,dc_levels+1):
        ...
        Bz2 = B(Hz2,Hc,mu_a,Bs, -sign)
        Phi = Acore*Nsense*Bz1+Acore*Nsense*Bz2          
        ...
        Phys=Pdiss(Bz1,Hz1,2*period,Acore*L)+Pdiss(Bz2,Hz2,2*period,Acore*L)
        ...
        Bz_wire[loop_index,:]=Bz1
        Hz_wire[loop_index,:]=Hz1
